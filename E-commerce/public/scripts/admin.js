...
function bindToGrid(results){
		...
		$('#productTable').html('<table id="productTable" class="table table-responsive table-bordered">' +
							'<tr><th>Photo</th><th>Product Name</th><th>Product Details</th> <th>Product Price</th><th>Product Category</th><th>Quantity</th><th>Added Date</th><th>Availability</th><th>Edit</th><th>Delete</th>' +
							'</tr></table>');
...
// Check if product quantity is zero
    if (product.quantity == 0) {product.productAvailability = 'Out_of_Stock';}
		var results = productRetreive();
